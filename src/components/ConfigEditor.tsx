  ...
  return (
    <>
      ...
      <InlineField grow label="User" labelWidth={20}>
        <Input placeholder="User" required value={jsonData.user} width={40} onChange={onChangeString('user')} />
      </InlineField>
      ...
      <InlineField grow label="Hostname" labelWidth={20}>
        <Input placeholder="localhost" value={jsonData.hostname} width={40} onChange={onChangeString('hostname')} />
      </InlineField>
      <InlineField grow label="Port" labelWidth={20}>
        <Input placeholder="1521" type="number" value={jsonData.port} width={40} onChange={onChangeNumber('port')} />
      </InlineField>
      <InlineField grow label="Service" labelWidth={20}>
        <Input placeholder="" value={jsonData.service} width={40} onChange={onChangeString('service')} />
      </InlineField>
      <InlineField grow label="Max open connections" labelWidth={20}>
        <Input placeholder="25" value={jsonData.maxOpenConns} width={40} onChange={onChangeNumber('maxOpenConns')} />
      </InlineField>
      <InlineField grow label="Max Idle connections" labelWidth={20}>
        <Input placeholder="25" value={jsonData.maxIdleConns} width={40} onChange={onChangeNumber('maxIdleConns')} />
      </InlineField>
      <InlineField grow label="Max idle time" labelWidth={20}>
        <Input placeholder="1m" value={jsonData.maxIdleTime} width={40} onChange={onChangeString('maxIdleTime')} />
      </InlineField>
      <InlineField grow label="Max life time" labelWidth={20}>
        <Input placeholder="5m" value={jsonData.maxLifeTime} width={40} onChange={onChangeString('maxLifeTime')} />
      </InlineField>
    </>
  );
}
